...
const privateExamplesDirName = require("../../examples.config").private;

const PAGES_PATH = join(__dirname, "..", "pages");
const EXAMPLES_OUTPUT_PATH = join(__dirname, "..", "examples.js");
const EXAMPLES_FILE_SYSTEM_PATHS = readdirSync(EXAMPLES_PATH).filter(
  f =>
    statSync(join(EXAMPLES_PATH, f)).isDirectory() &&
    (process.env.NODE_ENV !== "production" ||
      !privateExamplesDirName.includes(f))
);
